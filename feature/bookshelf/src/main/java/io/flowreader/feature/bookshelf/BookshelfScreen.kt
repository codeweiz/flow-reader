...
import io.flowreader.feature.bookshelf.domain.GetBooksUseCase

class BookshelfScreen(
    private val repository: BookRepository,
    private val onImportClick: () -> Unit,
    private val onNavigateToReader: (Navigator, String) -> Unit
) : Screen {
    ...
    override fun Content() {
        ...
        Scaffold(
            ...
            BookshelfContent(
                ...
                onBookClick = { book -> onNavigateToReader(navigator, book.id) },
